...
let self = _self // overrides; _self = with self; {
  ...
  AppSqitch = buildPerlModule {
    ...
    buildInputs = [
      ...
      ClassXSAccessor TypeTinyXS
    ];
    propagatedBuildInputs = [
      Clone ConfigGitLike DBI DateTime DevelStackTrace
      EncodeLocale FileHomeDir HashMerge IOPager
      IPCRun3 IPCSystemSimple ListMoreUtils Moo
      PathClass PerlIOutf8_strict StringFormatter
      StringShellQuote SubExporter TemplateTiny
  ...
  TypeTinyXS = buildPerlPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "a93ed33fd21646548ab5cdb0de647cc574ad3e41b414af7980526e8612cacb16";
    };
    meta = {
